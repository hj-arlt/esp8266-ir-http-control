 ...
 * 
 * As of the ESP8266 Arduino Core 2.4.0 lwIP vesion 2.0 is default. 
 * This causes problems and crashing and it is recommended you use lwIP 1.4. 
 * Go to Tools > lwIP Variant > lwIP 1.4 (Prebuilt)
 */
...
/* 
 * choise of esp module 
 */
#define ESP32_01        0
#define AVISIO_URC150   1
...
const int timeZone = +2;                  // Timezone (-5 is EST, -2 Berlin sommer, -1 Berlin winter)
...
const int pins2 = 12;          // Transmitting 2, n.c
const int pins3 = 15;          // Transmitting 3, n.c
const int pins4 = 16;          // Transmitting 4, n.c
const int configpin = 13;      // Key config
#else
const int pinr1 = 14;          // (9) Receiving pin, HSPI_CLK, I2C_SCL, IR-TX
const int pins1 = 4;           // (16) Transmitting preset 1, GPIO, PWM3
const int pins2 = 5;           // (24) Transmitting preset 2, GPIO, IR-Rx
const int pins3 = 12;          // (10) Transmitting preset 3, HSPI_MISO
const int pins4 = 13;          // (12) Transmitting preset 4, HSPI_MOSI
const int configpin = 10;      // (19) Reset Pin GPIO10, SDIO_DATA_3, SPIWP
#endif
